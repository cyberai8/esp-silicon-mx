...
constexpr int32_t kListPadBottom   = 72;  // 给右下角切换钮留空
...
constexpr int32_t kToggleBtnSize   = 56;
constexpr int32_t kToggleIconSize  = 32;
constexpr int32_t kToggleBtnMargin = 22;
